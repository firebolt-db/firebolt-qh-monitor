...
, COUNT(CASE WHEN scanned_bytes_cache > 0 THEN 1 ELSE NULL END) AS "Cold Queries"
, COUNT(CASE WHEN scanned_bytes_cache > 0 THEN 1 ELSE NULL END) / COUNT(CASE WHEN scanned_bytes_cache =0 THEN 1 ELSE NULL END)::DOUBLE AS "Cold Query Percentage"
